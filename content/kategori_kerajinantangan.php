...
<body>
  <h3 class="text-center font-weight-bold">Kerajinan Tangan</h3>
  <br/>
  <table class="table table-striped">
    ...
    <tbody>
    <?php
      $sql  = "SELECT p.id, p.kat_id, p.nama_produk, p.harga, p.stok, p.detail, p.gambar, k.nama_kategori FROM produk p INNER JOIN kategori k ON k.id = p.kat_id WHERE k.id ='3'";
