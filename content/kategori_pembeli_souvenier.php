...
<body>
  <h3 class="text-center font-weight-bold">Souvenier</h3>
  <center><a href="?page=kategori_pembeli" class="btn btn-primary">Kembali</a></center>
  <br/>
  <div class="row">
  	<?php 
  		$sql  = "SELECT p.id, p.kat_id, p.nama_produk, p.harga, p.stok, p.detail, p.gambar, k.nama_kategori FROM produk p INNER JOIN kategori k ON k.id = p.kat_id WHERE k.id ='4'";
